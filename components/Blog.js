      ...
      <div className="w-full p-4 border-t-2  border-gray-400">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center">
            ...
            />
            <a
              className="text-xs ml-3 md:font-semibold"
        ...
        <div className="blog_info">
          ...
          <div className="relative sm:absolute bottom-0 left-0 right-0 sm:mb-4 w-full px-3 flex items-center justify-between mt-3">
            {/* Likes/Up votes */}
            <div className="user_reaction group">
              <svg
                className="text-3xl p-1 rounded-lg mr-1 group-hover:bg-gray-100 group-hover:fill-[#39e58c]"
                viewBox="0 0 24 24"
          ...
          {/* Mobile Share Option */}
          {shareSupport && (
            <div className="block sm:hidden text-center font-semibold bg-purple-400 py-1 m-1 rounded-md">
