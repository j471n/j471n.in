          ...
          {buttonText && (
            <div className="flex gap-4 mt-4 md:mt-4 justify-center md:justify-start text-xs sm:text-base">
              <AnimatedButton
                ...
                className={`px-2 py-1 transition-all font-medium relative hover:text-white z-10 before:-z-10 before:absolute before:inset-0 before:w-0.5 before:transition-all before:hover:w-full  select-none text-xs sm:text-base text-gray-800 dark:text-gray-200 !scroll-smooth ${buttonClass}`}
