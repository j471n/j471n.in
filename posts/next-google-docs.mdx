...
image: https://imgur.com/UqOKl6g.png
---
...
- [How to start?](#how-to-start)
  ...
  - [Setting `.env.local`](#setting-envlocal)
- [What does it look like?](#what-does-it-look-like)
  - [LoginScreen](#loginscreen)
  - [Home Screen after Login](#home-screen-after-login)
  - [Document Screen](#document-screen)
- [Features](#features)
  - [Dark Mode Support](#dark-mode-support)
  - [Creating New Document](#creating-new-document)
  - [Open document in the new tab](#open-document-in-the-new-tab)
  - [Delete a document](#delete-a-document)
  - [Edit you Document](#edit-you-document)
  - [Download your document as PDF](#download-your-document-as-pdf)
