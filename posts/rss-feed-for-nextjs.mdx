...
- [Method-1](#method-1)
  - [Getting the Blogs' data](#getting-the-blogs-data)
  - [Install the `feed` package](#install-the-feed-package)
  - [Create RSS Feed](#create-rss-feed)
- [Method-2](#method-2)
  - [Install `rss` package](#install-rss-package)
  - [Generating RSS](#generating-rss)
