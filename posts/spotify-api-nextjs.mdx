...
image : /blogs/spotify-api-nextjs/banner.png
---
...
- [Authentication with `refresh_token`](#authentication-with-refresh_token)
  - [Authorization Code](#authorization-code)
  - [Get `refresh_token`](#get-refresh_token)
- [Setting up Environment Variables](#setting-up-environment-variables)
- [Using Spotify API](#using-spotify-api)
  - [Fetch the Top Tracks](#fetch-the-top-tracks)
    - [Creating API route top tracks](#creating-api-route-top-tracks)
  - [Fetch the Top Artist](#fetch-the-top-artist)
    - [Creating API route top artists](#creating-api-route-top-artists)
  - [Fetch the Currently Playing Song](#fetch-the-currently-playing-song)
    - [Creating API route for Currently Playing Song](#creating-api-route-for-currently-playing-song)
...
<CodeTitle title="lib/spotify.js" />
```js
...
<CodeTitle title="pages/api/stats/tracks.js" />
```js
...
<CodeTitle title="localhost:3000/api/stats/tracks" />
```json
[
  // ...........
 {
...
<CodeTitle title="pages/api/stats/artists.js" />
```js
...
<CodeTitle title="pages/api/now-playing .js" />
```js
