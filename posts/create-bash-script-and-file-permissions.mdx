...
image: https://imgur.com/3Rlnncs.png
---
...
- [Let's Create Bash Script](#lets-create-bash-script)
  - [Step - 1 : Create the Script](#step---1--create-the-script)
  - [Step - 2 : Edit the Script](#step---2--edit-the-script)
