...
<CodeTitle title="Example" />
```bash /home/jatinsharma/Desktop/Bash ```
...
<CodeTitle title="single-line-comment.sh" />
```bash # !/bin/bash
...
<CodeTitle title="multiline-comment.sh" />
```bash
#!/bin/bash
