...
image: https://imgur.com/Sdss9LN.png
---
...
- [Problem](#problem)
- [1. Using Flexbox](#1-using-flexbox)
- [2. Using Position](#2-using-position)
- [3. Using CSS grid](#3-using-css-grid)
- [4. Using `margin: auto` on a `flex` item](#4-using-margin-auto-on-a-flex-item)
- [5. Pseudo-elements on a `flex` container](#5-pseudo-elements-on-a-flex-container)
- [6. `margin: auto` on a `grid` item](#6-margin-auto-on-a-grid-item)
