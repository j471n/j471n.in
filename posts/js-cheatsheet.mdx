...
image: https://imgur.com/6ooVg2N.png
---
...
- [Iterators](#iterators)
  ...
  - [Array Method `.forEach()`](#array-method-foreach)
  - [Array Method `.map()`](#array-method-map)
  - [Array Method `.filter()`](#array-method-filter)
  - [Array Method `.reduce()`](#array-method-reduce)
- [Objects](#objects)
...
- [Modules](#modules)
  - [Import Javascript modules with the require function](#import-javascript-modules-with-the-require-function)
  - [Intermediate Javascript: Export Module](#intermediate-javascript-export-module)
  - [Javascript export default](#javascript-export-default)
  - [Using the `import` keyword in Javascript](#using-the-import-keyword-in-javascript)
- [Promises](#promises)
  - [JavaScript Promise Object](#javascript-promise-object)
  - [States of a JavaScript Promise](#states-of-a-javascript-promise)
  - [Creating a Javascript Promise object](#creating-a-javascript-promise-object)
  - [Executor function of JavaScript Promise object](#executor-function-of-javascript-promise-object)
    - [setTimeout()](#settimeout)
  - [`.then()` method of a JavaScript Promise object](#then-method-of-a-javascript-promise-object)
  - [Chaining multiple `.then()` methods](#chaining-multiple-then-methods)
  - [The `.catch()` method for handling rejection](#the-catch-method-for-handling-rejection)
  - [Avoiding nested Promise and `.then()`](#avoiding-nested-promise-and-then)
  - [JavaScript `Promise.all()`](#javascript-promiseall)
- [Async-Await](#async-await)
  - [Asynchronous JavaScript function](#asynchronous-javascript-function)
  - [JavaScript `async...await` operator](#javascript-asyncawait-operator)
  - [JavaScript async…await advantage](#javascript-asyncawait-advantage)
  - [Async Function Error Handling](#async-function-error-handling)
  - [Using async await syntax](#using-async-await-syntax)
  - [Resolving JavaScript Promises](#resolving-javascript-promises)
- [Requests](#requests)
  ...
  - [XMLHttpRequest GET Request Requirements](#xmlhttprequest-get-request-requirements)
  - [HTTP POST request with the XMLHttpRequest API](#http-post-request-with-the-xmlhttprequest-api)
  - [`fetch()` method](#fetch-method)
  - [`Response.ok` property fetch api](#responseok-property-fetch-api)
  - [Fetch API Function](#fetch-api-function)
  - [JSON Formatted response body](#json-formatted-response-body)
  - [fetch with `Async...Await`](#fetch-with-asyncawait)
...
Control structures such as conditionals ( if statements and the like) alter control 􀄳ow by only executing blocks of code if certain conditions are met. These structures essentially allow a program to make decisions about which code is executed as the program runs.
...
**Note**: If break is omitted from the block of a case , the switch statement will continue to check against case values until a break is encountered or the 􀄳ow is broken.
